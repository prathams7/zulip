...
class MessagePOSTTest(ZulipTestCase):
    ...
    def test_sending_message_as_stream_post_policy_restrict_new_members(self) -> None:
        ...
        do_set_realm_property(
            admin_profile.realm, "waiting_period_threshold", 10, acting_user=admin_profile
        )
    ...
    def test_personal_message_to_deactivated_user(self) -> None:
        ...
        othello = self.example_user("othello")
        cordelia = self.example_user("cordelia")
        do_deactivate_user(othello, acting_user=othello)
        self.login("hamlet")
...
class StreamMessagesTest(ZulipTestCase):
    ...
    def test_wildcard_mention_restrictions(self) -> None:
        ...
        do_set_realm_property(realm, "waiting_period_threshold", 10, acting_user=iago)
        ...
        cordelia.save()
        do_set_realm_property(
            realm, "wildcard_mention_policy", Realm.WILDCARD_MENTION_POLICY_ADMINS, acting_user=iago
        )
        self.send_and_verify_wildcard_mention_message("cordelia", test_fails=True)
        # There is no restriction on small streams.
        self.send_and_verify_wildcard_mention_message("cordelia", sub_count=10)
        ...
        do_set_realm_property(
            realm, "wildcard_mention_policy", Realm.WILDCARD_MENTION_POLICY_NOBODY, acting_user=iago
        )
    ...
    def test_invalid_wildcard_mention_policy(self) -> None:
        ...
        do_set_realm_property(cordelia.realm, "wildcard_mention_policy", 10, acting_user=admin)
        content = "@**all** test wildcard mention"
